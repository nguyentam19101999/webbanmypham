  ...
  $open = "product";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") 
    {
      $data = 
       ...
       if (postInput('number') < 0 ) {
        $error['number'] = "Số lượng phải lớn hơn 0"; 
       }
       if (postInput('sale') < 0 ) {
        $error['sale'] = "Giá khuyến mãi phải lớn hơn hoặc bằng 0"; 
      } 
            ...
            <div class="col-md-12">
                <form class="form-horizontal" action="" method="POST" enctype="multi/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="number" class="form-control" id="inputEmail3" placeholder="9.000.000"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <?php endif ?>
                            <img src="<?php echo uploads() ?>product/<?php echo $Editproduct['thunbar']?>" width="50px"
                                height="50px">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea class="form-control" name="content"
                                    rows="4"><?php echo $Editproduct['content'] ?></textarea>
