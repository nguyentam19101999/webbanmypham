                                ...
                                <ul class="pagination" >
                                    ...
                                    <li>
                                        ...
                                        <?php 
                                         ...
                                         ?>
                                         <li class="<?php echo ($i == $p) ?'active' : '' ?> "style="width:30px;text-align:center;padding-top:8px;text-decoration: none;display: inline-block;">
                                            <a href="?page=<?php echo $i;?>" style="text-align:center;"><?php echo $i;?> </a>                 
                                         </li>
                                     <?php endfor; ?>
                                    </li>
